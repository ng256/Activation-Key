...
namespace System.Security.Activation
{
    ...
    public class ActivationKeyManager
    {
        ...
        /// </summary>
        public static ActivationKeyManager Base10Manager => new ActivationKeyManager(BaseEncodingType.Base10);

        /// <summary>
        /// Returns a new instance of the <see cref="ActivationKeyManager"/> using hexadecimal encoding.
        /// </summary>
        public static ActivationKeyManager Base16Manager => new ActivationKeyManager(BaseEncodingType.Base16);

        /// <summary>
        /// Returns a new instance of the <see cref="ActivationKeyManager"/> using base32 encoding.
        /// </summary>
        public static ActivationKeyManager Base32Manager => new ActivationKeyManager(BaseEncodingType.Base32);

         /// <summary>
        /// Returns a new instance of the <see cref="ActivationKeyManager"/> using base64 encoding.
        /// </summary>
        public static ActivationKeyManager Base64Manager => new ActivationKeyManager(BaseEncodingType.Base64);
        ...
        public ActivationKeyManager(ushort header, IBaseEncoding encoding, params char[] delimiters)
        {
        ...
        /// <param name="encoding">Encoding used to encode/decode activation key data.</param>
        /// <param name="delimiters">An array of characters that are used to split the string into parts of the activation key.</param>
        public ActivationKeyManager(IBaseEncoding encoding, params char[] delimiters)
        {
            _textParser = new ActivationKeyTextParser(encoding, delimiters);
        }
        ...
        /// <param name="encoding">Encoding used to encode/decode activation key data.</param>
        /// <param name="delimiters">An array of characters that are used to split the string into parts of the activation key.</param>
        public ActivationKeyManager(ushort header, BaseEncodingType encoding, params char[] delimiters)
        {
            _textParser = new ActivationKeyTextParser(encoding, delimiters);
            _binaryParser = new ActivationKeyBinaryParser(header);
        }
        ...
        /// <param name="encoding">Encoding used to encode/decode activation key data.</param>
        /// <param name="delimiters">An array of characters that are used to split the string into parts of the activation key.</param>
        public ActivationKeyManager(BaseEncodingType encoding, params char[] delimiters)
        {
            _textParser = new ActivationKeyTextParser(encoding, delimiters);
        }
        ...
        /// <summary>
        /// Reads the activation key from the registry.
        /// </summary>
